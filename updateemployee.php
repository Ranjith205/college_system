                        ...
                        <form role="form" data-parsley-validate novalidate>
                                           ...
                                           <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" required parsley-type="text" class="form-control"
                                                           id="name" placeholder="name" value="Hemant Kumar">
                                                </div>
                                            </div>
                            ...
                            <div class="form-group row">
                             ...
                             <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" required parsley-type="text" class="form-control"
                                                           id="name" placeholder="Joining Date" value="20-05-2009">
                                                </div>
                                            </div>
                            ...
                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" required parsley-type="text" class="form-control"
                                                           id="name" placeholder="Subject" value="English">
                                </div></div>
                             ...
                             <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="number" required parsley-type="number" class="form-control"
                                                           id="name" placeholder="mobile no." value="987634564">
                                                </div>
                                            </div>
                            
                            <div class="form-group row">
                                                <label for="aadhaar" class="col-sm-4 form-control-label">Aadhaar no.<span class="text-danger">*</span></label>
                                                <div class="col-sm-7">
                                                    <input type="number" required parsley-type="number" class="form-control"
                                                           id="name" placeholder="Aadhaar no." value="1265778645673456">
                                                </div>
                                            </div>
                             <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" required parsley-type="text" class="form-control"
                                                           id="name" placeholder="Address" value="crossings 23, 4th avenue New Delhi">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="email" required parsley-type="email" class="form-control"
                                                           id="inputEmail3" placeholder="Email" value="hemant@college.com">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                <label for="hori-pass2" class="col-sm-4 form-control-label">Confirm New Password
